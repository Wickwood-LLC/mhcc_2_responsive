...
function mhcc_2_process_html(&$vars) {
  dpm($vars);
}
...
<?php
    ...
    public function print_maintenance_head($vars)
    {
        foreach (array_keys($vars) as $name) {
            $$name = &$vars[$name];
        }
...
<div id="comments" class="art-comments">
	<div class="art-comment art-postcontent <?php print($comment->new) ? ' comment-new' : '';
        print ' ' . $status;
        print ' ' . $zebra;?>">
		...
		<div class="art-comment-avatar">
            ...
            print '<img src="' . get_full_path_to_theme() . '/images/no-avatar.jpg" alt="No Avatar">';
        }
        ?>
		</div>
...
<div id="comments">
  <?php print $content;?>
    ...
    public function get_incorrect_version_message()
    {
